...
// Kéo-thả sắp xếp/lồng danh mục kiểu WordPress — cùng cơ chế với MenuTreeEditor
// (backend/src/menus dùng order+parentId, giờ Category cũng có cột order tương tự).
